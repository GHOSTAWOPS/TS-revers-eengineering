...
5. 后续开发仍按旧图石运行、IDA、SFL、Detail 证据闭合业务缺口；`TODO-029 / Rebar.Edit.Move P0`、`TODO-032 / Rebar.Edit.Copy P0`、`TODO-030 / M2-Stats-001`、`TODO-031 / M2-Drawing-001`、`TODO-033 / M2-Drawing-002`、`TODO-034 / M2-Drawing-003`、`TODO-035 / M2-Drawing-004`、`TODO-036 / M2-Drawing-005`、`TODO-037 / M2-Drawing-006`、`TODO-038 / M2-Drawing-007`、`TODO-039 / M2-Drawing-008` 和 `TODO-040 / M2-Drawing-009` 已纳入 done-report 映射。下一步建议按 `TODO-041 / M2-Drawing-010` 做 line-containers AutoCAD L2 运行确认准备，或在用户能启动 AutoCAD 2020 时继续执行 `69/72/73/74/75/76` 的手工 L2 导入清单；`TODO-026` golden 采集保持 pending，不自动进入。
