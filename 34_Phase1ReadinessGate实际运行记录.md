...
5. 后续开发仍按旧图石运行、IDA、SFL、Detail 证据闭合业务缺口；`TODO-029 / Rebar.Edit.Move P0`、`TODO-032 / Rebar.Edit.Copy P0`、`TODO-030 / M2-Stats-001`、`TODO-031 / M2-Drawing-001`、`TODO-033 / M2-Drawing-002`、`TODO-034 / M2-Drawing-003`、`TODO-035 / M2-Drawing-004`、`TODO-036 / M2-Drawing-005`、`TODO-037 / M2-Drawing-006`、`TODO-038 / M2-Drawing-007`、`TODO-039 / M2-Drawing-008`、`TODO-040 / M2-Drawing-009`、`TODO-041 / M2-Drawing-010`、`TODO-042 / M2-Drawing-011`、`TODO-043 / M2-Drawing-012`、`TODO-044 / M2-Drawing-013`、`TODO-045 / M2-Drawing-014`、`TODO-046 / M2-Drawing-015` 和 `TODO-047 / M2-Drawing-016` 已纳入 done-report 映射。`TODO-048 / 旧图石启动阻塞提示链补证 P0` 已用 `E-IDA-030 / E-DEV-070` 静态闭合启动主链、`41 -> 许可已过期`、其他非 `0` 失败码回落到 `请检查网线是否接好` 和用户手工解除前置条件清单；`TODO-049` 继续补入 `E-RUN-004` 后已经闭环：用户确认旧图石在 USB 狗插入后可进入主界面、可打开 `SFL`、不需要内网，但仍需本地 HASP 安装条件。当前 strict readiness 仍是 `84/84 pass`。下一步建议切到 `TODO-050 / 旧图石非空接头线 Others 运行样例采集 P0`，在旧图石已可启动的前提下采真正的命令运行样例；用户能启动 AutoCAD 2020 时，仍可按 `69/72/73/74/75/77/78/80/81/82/83/84/85` 的手工清单继续 L2 导入确认；`TODO-026` golden 采集保持 pending，不自动进入。
