...
5. 后续开发仍按旧图石运行、IDA、SFL、Detail 证据闭合业务缺口；`TODO-029 / Rebar.Edit.Move P0`、`TODO-032 / Rebar.Edit.Copy P0`、`TODO-030 / M2-Stats-001`、`TODO-031 / M2-Drawing-001`、`TODO-033 / M2-Drawing-002`、`TODO-034 / M2-Drawing-003`、`TODO-035 / M2-Drawing-004`、`TODO-036 / M2-Drawing-005`、`TODO-037 / M2-Drawing-006`、`TODO-038 / M2-Drawing-007`、`TODO-039 / M2-Drawing-008`、`TODO-040 / M2-Drawing-009`、`TODO-041 / M2-Drawing-010`、`TODO-042 / M2-Drawing-011`、`TODO-043 / M2-Drawing-012`、`TODO-044 / M2-Drawing-013` 和 `TODO-045 / M2-Drawing-014` 已纳入 done-report 映射。`TODO-045` 当前只闭合了接头线 / Others 写出链和证据 GAP 收敛，不代表真实算法、AutoCAD L2 或旧插件接受度已闭合。下一步建议按 `TODO-046 / M2-Drawing-015` 继续追接头线半长参数绑定、`pattern + 192 == 76` 枚举名、额外 arc 分支条件和 `Others / symbolcutIOS` 运行触发路径；用户能启动 AutoCAD 2020 时，仍可按 `69/72/73/74/75/77/78/80/81` 的手工清单继续 L2 导入确认；`TODO-026` golden 采集保持 pending，不自动进入。
