# STEP Selection Diff: cc003_bspline_length

- Source STEP: `/mnt/c/users/ghost/desktop/reverse_engineering/tests/golden/complex_curve_rebar/CC-003-real-length-vs-polyline-length/input/input.step`
