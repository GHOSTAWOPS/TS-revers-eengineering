# STEP Selection Diff: cc002_bezier_edge

- Source STEP: `/mnt/c/users/ghost/desktop/reverse_engineering/tests/golden/complex_curve_rebar/CC-002-bezier-edge-to-rebar/input/input.step`
