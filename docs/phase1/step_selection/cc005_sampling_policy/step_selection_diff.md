# STEP Selection Diff: cc005_sampling_policy

- Source STEP: `/mnt/c/users/ghost/desktop/reverse_engineering/tests/golden/complex_curve_rebar/CC-005-sampling-policy/input/input.step`
