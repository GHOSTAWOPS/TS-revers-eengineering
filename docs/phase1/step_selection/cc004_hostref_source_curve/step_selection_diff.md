# STEP Selection Diff: cc004_hostref_source_curve

- Source STEP: `/mnt/c/users/ghost/desktop/reverse_engineering/tests/golden/complex_curve_rebar/CC-004-hostref-and-source-curve-preservation/input/input.step`
