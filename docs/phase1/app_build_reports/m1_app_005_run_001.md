...
```text
decision = m1-app-005-pass
```

本轮完成 `LegacyGeometryAdapter P1`。
...
LegacyBoundingBox
LegacyBoundaryLoop
edgePointAtParameter
edgeSamplePoints
edge / face fingerprint
face boundary loops
```
...
```text
edge bbox / pointAtParameter / samplePoints / fingerprint
face bbox / boundary loops / outer loop / fingerprint
wrong type / missing part / out-of-range diagnostics
```
